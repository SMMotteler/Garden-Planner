...
public class Plant  extends ParseObject {
    ...
    public String getHarvestAdvice() {
        return getString(KEY_HARVEST_ADVICE);
    }

    public void setHarvestAdvice(String harvestAdvice) {
        put(KEY_HARVEST_ADVICE, harvestAdvice);
    }

    public int getPlantTime() {
        return getInt(KEY_PLANT_TIME);
    }

    public void setPlantTime(int plantTime) {
        put(KEY_PLANT_TIME, plantTime);
    }

    public int getHarvestTime() {
        return getInt(KEY_HARVEST_TIME);
    }

    public void setHarvestTime(int harvestTime) {
        put(KEY_HARVEST_TIME, harvestTime);
    }

    public String getPlantAdvice() {
        return getString(KEY_PLANT_ADVICE);
    }

    public void setPlantAdvice(String plantAdvice) {
        put(KEY_PLANT_ADVICE, plantAdvice);
    }
